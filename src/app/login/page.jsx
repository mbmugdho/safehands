...
export const metadata = {
  title: 'Login | SafeHands',
  description: 'Login to SafeHands to manage your caregiving bookings.',
}
          ...
          <form className="mt-8 space-y-6">
            ...
            <div className="flex items-center justify-between text-xs text-white/80">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="checkbox checkbox-xs bg-white/20 border-white/40 checked:bg-white/70 checked:border-white"
                />
